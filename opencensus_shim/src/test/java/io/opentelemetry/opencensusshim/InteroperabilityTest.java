...
public class InteroperabilityTest {
  ...
  public void testParentChildRelationshipsAreExportedCorrectly() {
    ...
    assertEquals("OpenCensusSpan", spanData2.getName());
    assertEquals(2, spanData2.getTotalRecordedEvents());
    assertEquals("OpenCensus: Event 1", spanData2.getEvents().get(0).getName());
    assertEquals("OpenCensus: Event 2", spanData2.getEvents().get(1).getName());
  ...
  private static void createOpenCensusScopedSpans() {
    ...
    try (io.opencensus.common.Scope scope =
      ...
      createOpenTelemetryScopedSpans();
      span.addAnnotation("OpenCensus: Event 2");
    }
    Tracing.getExportComponent().shutdown();
  }

  private static void createOpenTelemetryScopedSpans() {
