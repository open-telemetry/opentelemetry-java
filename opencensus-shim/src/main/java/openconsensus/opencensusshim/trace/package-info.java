 ...
 *
 * <p>{@link openconsensus.opencensusshim.trace.Span} represents a single operation within a trace.
 *
 * <p>{@link openconsensus.opencensusshim.trace.Span Spans} are propagated in-process in the {@code
 * io.grpc.Context} and between process using one of the wire propagation formats supported in the
 * {@code openconsensus.opencensusshim.trace.propagation} package.
 */
