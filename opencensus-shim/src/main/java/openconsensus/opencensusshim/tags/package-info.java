 ...
 * openconsensus.opencensusshim.stats} package labels all stats with the current tags.
 *
 * <p>{@link openconsensus.opencensusshim.tags.Tag Tags} are key-value pairs. The {@link
 * openconsensus.opencensusshim.tags.TagKey keys} and {@link
 * openconsensus.opencensusshim.tags.TagValue values} are wrapped {@code String}s. They are stored
 * as a map in a {@link openconsensus.opencensusshim.tags.TagContext}.
 *
