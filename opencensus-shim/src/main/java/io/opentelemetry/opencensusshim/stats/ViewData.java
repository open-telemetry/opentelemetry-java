...
import io.opentelemetry.opencensusshim.common.Functions;
import io.opentelemetry.opencensusshim.common.Timestamp;
import io.opentelemetry.opencensusshim.stats.Aggregation.Count;
import io.opentelemetry.opencensusshim.stats.Aggregation.Distribution;
import io.opentelemetry.opencensusshim.stats.Aggregation.LastValue;
import io.opentelemetry.opencensusshim.stats.Aggregation.Sum;
import io.opentelemetry.opencensusshim.stats.AggregationData.CountData;
import io.opentelemetry.opencensusshim.stats.AggregationData.DistributionData;
import io.opentelemetry.opencensusshim.stats.AggregationData.LastValueDataDouble;
import io.opentelemetry.opencensusshim.stats.AggregationData.LastValueDataLong;
import io.opentelemetry.opencensusshim.stats.AggregationData.SumDataDouble;
import io.opentelemetry.opencensusshim.stats.AggregationData.SumDataLong;
...
import io.opentelemetry.opencensusshim.stats.ViewData.AggregationWindowData.CumulativeData;
import io.opentelemetry.opencensusshim.tags.TagValue;
...
public abstract class ViewData {
  ...
  public static ViewData create(
    ...
    return windowData.match(
        new Function<CumulativeData, ViewData>() {
          @Override
