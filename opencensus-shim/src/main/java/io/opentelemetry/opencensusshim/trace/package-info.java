 ...
 *
 * <p>{@link io.opentelemetry.opencensusshim.trace.Span} represents a single operation within a
 * trace.
 *
 * <p>{@link io.opentelemetry.opencensusshim.trace.Span Spans} are propagated in-process in the
 * {@code io.grpc.Context} and between process using one of the wire propagation formats supported
 * in the {@code opentelemetry.opencensusshim.trace.propagation} package.
 */
