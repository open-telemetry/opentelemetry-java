...
class ExemplarFilterFactoryTest {
  ...
  void create(ExemplarFilterModel model, ExemplarFilter expectedResult) {
  ...
  private static Stream<Arguments> createTestCases() {
    return Stream.of(
        Arguments.argumentSet(
            "always_on", ExemplarFilterModel.ALWAYS_ON, ExemplarFilter.alwaysOn()),
        Arguments.argumentSet(
            "always_off", ExemplarFilterModel.ALWAYS_OFF, ExemplarFilter.alwaysOff()),
        Arguments.argumentSet(
            "trace_based", ExemplarFilterModel.TRACE_BASED, ExemplarFilter.traceBased()));
  }
}
