...
/**
 * Provides typed access to experimental properties on {@link LogRecordExporterModel}.
 *
 * <p>This class is internal and experimental. Its APIs are unstable and can change at any time. Its
 * APIs (or a version of them) may be promoted to the public stable API in the future, but no
 * guarantees are made.
 */
public final class LogRecordExporterModelAccessor {

  private LogRecordExporterModelAccessor() {}
  ...
  @Nullable
  public static ExperimentalOtlpFileExporterModel getOtlpFile(LogRecordExporterModel model) {
