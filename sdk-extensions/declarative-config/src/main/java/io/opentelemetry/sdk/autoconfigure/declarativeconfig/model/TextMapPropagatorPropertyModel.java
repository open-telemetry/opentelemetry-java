...
public class TextMapPropagatorPropertyModel {
  ...
  public String toString() {
    return "TextMapPropagatorPropertyModel{" + "additionalProperties=" + additionalProperties + "}";
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o instanceof TextMapPropagatorPropertyModel) {
      TextMapPropagatorPropertyModel that = (TextMapPropagatorPropertyModel) o;
