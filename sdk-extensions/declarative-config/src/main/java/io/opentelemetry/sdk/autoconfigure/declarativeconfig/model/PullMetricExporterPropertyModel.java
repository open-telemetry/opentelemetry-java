...
public class PullMetricExporterPropertyModel {
  ...
  public String toString() {
    ...
    sb.append(PullMetricExporterPropertyModel.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    if ((other instanceof PullMetricExporterPropertyModel) == false) {
      return false;
    }
    PullMetricExporterPropertyModel rhs = ((PullMetricExporterPropertyModel) other);
