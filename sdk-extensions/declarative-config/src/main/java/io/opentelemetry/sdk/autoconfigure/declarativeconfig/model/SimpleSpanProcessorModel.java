...
public class SimpleSpanProcessorModel {
  ...
  public String toString() {
    ...
    sb.append(SimpleSpanProcessorModel.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    if ((other instanceof SimpleSpanProcessorModel) == false) {
      return false;
    }
    SimpleSpanProcessorModel rhs = ((SimpleSpanProcessorModel) other);
