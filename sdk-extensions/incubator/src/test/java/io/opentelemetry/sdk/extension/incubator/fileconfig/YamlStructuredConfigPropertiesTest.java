...
class YamlStructuredConfigPropertiesTest {
  ...
  void additionalProperties() {
    ...
    assertThat(otherProps.getScalarList("str_list_key")).isEqualTo(Arrays.asList("val1", "val2"));
    assertThat(otherProps.getScalarList("int_list_key")).isEqualTo(Arrays.asList("1", "2"));
    assertThat(otherProps.getScalarList("float_list_key")).isEqualTo(Arrays.asList("1.1", "2.2"));
    assertThat(otherProps.getScalarList("bool_list_key")).isEqualTo(Arrays.asList("true", "false"));
  ...
  void defaults() {
    ...
    assertThat(structuredConfigProps.getScalarList("foo", Collections.singletonList("bar")))
  ...
  void missingKeys() {
    ...
    assertThat(structuredConfigProps.getScalarList("foo")).isNull();
  ...
  void wrongType() {
    ...
    assertThat(otherProps.getScalarList("str_key")).isNull();
