...
class ServiceEntityDetectorTest {
  ...
  void testDetect() {
    ...
    Entity serviceEntity = list.get(0);
    assertThat(serviceEntity.getType()).isEqualTo("service");
    assertThat(serviceEntity.getId())
    ...
    Entity serviceInstanceEntity = list.get(1);
    assertThat(serviceInstanceEntity.getType()).isEqualTo("service.instance");
    assertThat(serviceInstanceEntity.getId().get(ServiceEntityDetector.SERVICE_INSTANCE_ID))
        .isNotNull()
        .isNotEmpty();
    ...
    Entity serviceInstanceEntity2 = list2.get(1);
    assertThat(serviceInstanceEntity2.getId().get(ServiceEntityDetector.SERVICE_INSTANCE_ID))
        .isEqualTo(serviceInstanceEntity.getId().get(ServiceEntityDetector.SERVICE_INSTANCE_ID));
  }
}
