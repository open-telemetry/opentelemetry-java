...
class TracezZPageHandlerTest {
  ...
  @Test
  void spanDetails_emitNameWithSpaceCorrectly() throws URISyntaxException {
    OutputStream output = new ByteArrayOutputStream();
  ...
  @Test
  void spanDetails_emitNameWithPlusCorrectly() throws URISyntaxException {
    OutputStream output = new ByteArrayOutputStream();
  ...
  @Test
  void spanDetails_emitNamesWithSpaceAndPlusCorrectly() throws URISyntaxException {
    OutputStream output = new ByteArrayOutputStream();
  ...
  @Test
  void spanDetails_emitNamesWithSpecialUrlCharsCorrectly() throws URISyntaxException {
    OutputStream output = new ByteArrayOutputStream();
