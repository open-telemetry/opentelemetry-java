...
public final class ZipkinSpanExporter implements SpanExporter {
  ...
  static final String KEY_INSTRUMENTATION_LIBRARY_NAME = "otel.instrumentation.name";
  static final String KEY_INSTRUMENTATION_LIBRARY_VERSION = "otel.instrumentation.version";
