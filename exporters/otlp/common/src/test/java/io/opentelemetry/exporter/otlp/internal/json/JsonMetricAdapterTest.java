...
class JsonMetricAdapterTest {
  ...
  void toInt64DataPoints() {
    ...
    JSONArray actualJsonArray =
        JsonMetricAdapter.toIntDataPoints(
            singletonList(
    ...
    boolean containsExactly2 =
        JsonCompareUtil.containsExactly(actualJsonArray2, exceptedJsonArray2);
  ...
  void toDoubleDataPoints() {
    ...
    JSONArray actualJsonArray =
        JsonMetricAdapter.toDoubleDataPoints(
  ...
  void toSummaryDataPoints() {
    JSONArray actualJsonArray =
        JsonMetricAdapter.toSummaryDataPoints(
            singletonList(
  ...
  void toHistogramDataPoints() {
    JSONArray actualJsonArray =
        JsonMetricAdapter.toHistogramDataPoints(
            ImmutableList.of(
  ...
  void toProtoMetric_monotonic() {
    JSONObject actualJson =
        JsonMetricAdapter.toProtoMetric(
    ...
    JSONObject actualJson =
        JsonMetricAdapter.toProtoMetric(
            MetricData.createLongGauge(
                ...
                "description",
                "1",
                LongGaugeData.create(singletonList(LongPointData.create(123, 456, KV_ATTR, 5)))));
        ...
        JsonMetricAdapter.toProtoMetric(
            MetricData.createDoubleHistogram(
                ...
                DoubleHistogramData.create(
                    ...
                    singletonList(
                        DoubleHistogramPointData.create(
                            123, 456, KV_ATTR, 4.0, ImmutableList.of(), ImmutableList.of(33L))))));
  ...
  void toProtoResourceMetrics() throws InterruptedException {
    JSONArray actualJsonArray =
        JsonMetricAdapter.toJsonResourceMetrics(
            ImmutableList.of(
                MetricData.createDoubleSum(
                    ...
                    DoubleSumData.create(
                        /* isMonotonic= */ true,
                        AggregationTemporality.CUMULATIVE,
                        Collections.singletonList(DoublePointData.create(123, 456, KV_ATTR, 5.0)))),
                MetricData.createDoubleSum(
                    Resource.create(Attributes.of(stringKey("ka"), "va"), "http://resource.url"),
                    InstrumentationLibraryInfo.create("name", "version", "http://url"),
                    "name",
    ...
    instrumentationLibraryMetric.put(
        "instrumentation_library", getInstrumentationLibraryJson("name", "version"));
    ...
    emptyInstrumentationLibraryMetric1.put(
        "instrumentation_library", getInstrumentationLibraryJson("name", "version"));
    ...
    emptyInstrumentationLibraryMetric2.put(
        "instrumentation_library", getInstrumentationLibraryJson("", null));
    ...
    for (int i = 0; i < exceptedJsonArray.size(); i++) {
      containsExactly =
          JsonCompareUtil.containsExactly(actualJsonArray, exceptedJsonArray.getJSONObject(i));
    }
    assertThat(containsExactly).isTrue();
  }
