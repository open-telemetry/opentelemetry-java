...
class JsonCommonAdapterTest {
    ...
    void toProtoAttribute_Bool() {
        ...
        assertThat(JsonCommonAdapter.toJsonAttribute(booleanKey("key"), true))
                .isEqualTo(keyValue);
    }
    ...
    void toProtoAttribute_String() {
        ...
        keyValue.put("value", anyValue);
        assertThat(JsonCommonAdapter.toJsonAttribute(stringKey("key"), "string"))
                .isEqualTo(keyValue);
    }
    ...
    void toProtoAttribute_StringArray() {
        ...
        assertThat(
                JsonCommonAdapter.toJsonAttribute(
                        stringArrayKey("key"), valueList))
                .isEqualTo(keyValue);
    }
    ...
    void toProtoAttribute_Int() {
        ...
        assertThat(JsonCommonAdapter.toJsonAttribute(longKey("key"), 100L))
                .isEqualTo(keyValue);
    }
    ...
    void toProtoAttribute_Double() {
        ...
        assertThat(JsonCommonAdapter.toJsonAttribute(doubleKey("key"), 100.3d))
                .isEqualTo(keyValue);
    }
    ...
    void toProtoAttribute_DoubleArray() {
        ...
        keyValue.put("value", anyValue);
        assertThat(JsonCommonAdapter.toJsonAttribute(doubleArrayKey("key"), Arrays.asList(100.3, 200.5)))
                .isEqualTo(keyValue);
    }
    ...
    void toProtoInstrumentationLibrary() {
        ...
        JSONObject instrumentationLibrary =
                JsonCommonAdapter.toProtoInstrumentationLibrary(info);
        assertThat(instrumentationLibrary.get("name")).isEqualTo("name");
        assertThat(instrumentationLibrary.get("version")).isEqualTo("version");
        // Memoized
        assertThat(JsonCommonAdapter.toProtoInstrumentationLibrary(info)).isSameAs(instrumentationLibrary);
    }
