...
class JsonResourceAdapterTest {
        ...
        Resource resource =
                Resource.create(
                        Attributes.of(
                                ...
                                100.3));
        JSONObject protoResource =
                JsonResourceAdapter.toProtoResource(resource);
        // Memoized
    ...
    void toProtoResource_Empty() {
        ...
        assertThat(JsonResourceAdapter.toProtoResource(Resource.empty()))
                .isEqualTo(protoResource);
    }
}