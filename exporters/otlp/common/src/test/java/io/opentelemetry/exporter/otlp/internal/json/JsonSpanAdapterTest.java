...
class JsonSpanAdapterTest {
    ...
    void toProtoResourceSpans() {
        ...
        JSONArray instrumentationLibrarySpans = (JSONArray) onlyResourceSpans.get("instrumentation_library_spans");
    ...
    void toProtoStatus() {
        ...
        assertThat(JsonSpanAdapter.toStatusProto(StatusData.unset()))
                .isEqualTo(statusCodeUnset);
