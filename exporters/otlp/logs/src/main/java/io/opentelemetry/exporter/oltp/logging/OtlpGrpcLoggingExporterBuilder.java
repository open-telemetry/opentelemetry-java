...
public class OtlpGrpcLoggingExporterBuilder {
   ...
   */
  public OtlpGrpcLoggingExporterBuilder setChannel(ManagedChannel channel) {
   ...
   */
  public OtlpGrpcLoggingExporterBuilder setTimeout(long timeout, TimeUnit unit) {
   ...
   * unset, defaults to {@value DEFAULT_TIMEOUT_SECS}s.
   */
  public OtlpGrpcLoggingExporterBuilder setTimeout(Duration timeout) {
   ...
   */
  public OtlpGrpcLoggingExporterBuilder setEndpoint(String endpoint) {
   ...
   * OtlpGrpcLoggingExporterBuilder#endpoint} is set to build channel.
   *
   * @param key header key
   * @param value header value
   * @return this builder's instance
   */
  public OtlpGrpcLoggingExporterBuilder addHeader(String key, String value) {
    if (metadata == null) {
   ...
   */
  public OtlpGrpcLogsExporter build() {
    if (channel == null) {
    ...
    return new OtlpGrpcLogsExporter(channel, timeoutNanos);
  }

  OtlpGrpcLoggingExporterBuilder() {}
}
