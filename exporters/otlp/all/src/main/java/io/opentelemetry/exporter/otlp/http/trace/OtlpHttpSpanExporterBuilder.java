...
public final class OtlpHttpSpanExporterBuilder {
  ...
  OtlpHttpSpanExporterBuilder() {
    this(
        new HttpExporterBuilder<>(
            "otlp", SemConvExporterMetrics.Signal.SPAN, "otlp_http_span_exporter", DEFAULT_ENDPOINT),
        DEFAULT_MEMORY_MODE);
  }
   ...
   * @since 1.50.0
   */
  public OtlpHttpSpanExporterBuilder setHealthMetricLevel(HealthMetricLevel level) {
