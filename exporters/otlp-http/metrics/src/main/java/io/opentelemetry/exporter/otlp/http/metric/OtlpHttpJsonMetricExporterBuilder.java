...
/** Builder utility for {@link OtlpHttpJsonMetricExporter}. */
public class OtlpHttpJsonMetricExporterBuilder {
     ...
     */
    public OtlpHttpJsonMetricExporterBuilder setTimeout(long timeout, TimeUnit unit) {
     ...
     * unset, defaults to {@value DEFAULT_TIMEOUT_SECS}s.
     */
    public OtlpHttpJsonMetricExporterBuilder setTimeout(Duration timeout) {
     ...
     */
    public OtlpHttpJsonMetricExporterBuilder setEndpoint(String endpoint) {
     ...
     */
    public OtlpHttpJsonMetricExporterBuilder setCompression(String compressionMethod) {
    ...
    public OtlpHttpJsonMetricExporterBuilder addHeader(String key, String value) {
     ...
     */
    public OtlpHttpJsonMetricExporterBuilder setTrustedCertificates(byte[] trustedCertificatesPem) {
    ...
    public OtlpHttpJsonMetricExporter build() {
        ...
        return new OtlpHttpJsonMetricExporter(clientBuilder.build(), endpoint, headers, compressionEnabled);
    }
    ...
    OtlpHttpJsonMetricExporterBuilder() {}
