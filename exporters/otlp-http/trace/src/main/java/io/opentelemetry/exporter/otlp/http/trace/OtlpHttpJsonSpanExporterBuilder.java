...
public final class OtlpHttpJsonSpanExporterBuilder {
   ...
   */
  public OtlpHttpJsonSpanExporterBuilder setTimeout(long timeout, TimeUnit unit) {
   ...
   * unset, defaults to {@value DEFAULT_TIMEOUT_SECS}s.
   */
  public OtlpHttpJsonSpanExporterBuilder setTimeout(Duration timeout) {
   ...
   */
  public OtlpHttpJsonSpanExporterBuilder setEndpoint(String endpoint) {
   ...
   */
  public OtlpHttpJsonSpanExporterBuilder setCompression(String compressionMethod) {
  ...
  public OtlpHttpJsonSpanExporterBuilder addHeader(String key, String value) {
   ...
   */
  public OtlpHttpJsonSpanExporterBuilder setTrustedCertificates(byte[] trustedCertificatesPem) {
