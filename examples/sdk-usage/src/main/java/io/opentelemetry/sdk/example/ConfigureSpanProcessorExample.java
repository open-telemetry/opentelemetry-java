...
/**
 * This example shows how to different Span Processors.
 */
class ConfigureSpanProcessorExample {
	...
	public static void main(String[] args) throws Exception {
		...
		// We can also implement our own SpanProcessor. It is necessary to only implement the relative interface
		...
		// We can also configure multiple span processors at the same time using the MultiSpanProcessor class.
