...
class HandlerTest {
  ...
  void two_requests() throws Exception {
    ...
    assertThat(finished.get(0).getSpanContext().getTraceIdHex())
        .isNotEqualTo(finished.get(1).getSpanContext().getTraceIdHex());
    assertThat(finished.get(0).getParentSpanContext().getSpanIdHex())
  ...
  void parent_not_picked_up() throws Exception {
    ...
    assertThat(parent.getSpanContext().getSpanIdHex())
        .isNotEqualTo(child.getParentSpanContext().getSpanIdHex());
  }
