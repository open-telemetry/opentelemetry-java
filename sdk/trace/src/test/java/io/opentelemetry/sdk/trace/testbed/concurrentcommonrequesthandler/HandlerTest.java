...
class HandlerTest {
  ...
  void two_requests() throws Exception {
    ...
    assertThat(finished.get(0).getTraceIdHex()).isNotEqualTo(finished.get(1).getTraceIdHex());
    assertThat(finished.get(0).getParentSpanIdHex()).isEqualTo(SpanId.getInvalid());
    assertThat(finished.get(1).getParentSpanIdHex()).isEqualTo(SpanId.getInvalid());
  ...
  void parent_not_picked_up() throws Exception {
    ...
    assertThat(parent.getSpanIdHex()).isNotEqualTo(child.getParentSpanIdHex());
  }
  ...
  void bad_solution_to_set_parent() throws Exception {
    ...
    assertThat(finished.get(1).getParentSpanIdHex()).isEqualTo(parent.getSpanIdHex());

    // third span should not have parent, but it has, damn it
    assertThat(finished.get(2).getParentSpanIdHex()).isEqualTo(parent.getSpanIdHex());
  }
}
