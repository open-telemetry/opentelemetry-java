...
public final class OpenTelemetryAssertions extends Assertions {
  ...
  /**
   * Returns an assertion for {@link ScopeMetricData}.
   *
   * @since 1.14.0
   */
  public static ScopeMetricAssert assertThat(@Nullable ScopeMetricData scopeMetricData) {
    return new ScopeMetricAssert(scopeMetricData);
  }
