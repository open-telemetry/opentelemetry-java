        ...
        .hasAttributesSatisfying(
            attributes ->
                assertThat(attributes)
                    ...
                    .containsStringArrayEntry("colors", "red", "blue")
                    .containsStringArrayEntry("colors", Arrays.asList("red", "blue"))
                    .containsBooleanArrayEntry("conditions", false, true)
                    .containsBooleanArrayEntry("conditions", Arrays.asList(false, true))
                    .containsLongArrayEntry("scores", 0L, 1L)
                    .containsLongArrayEntry("scores", Arrays.asList(0L, 1L))
                    .containsDoubleArrayEntry("coins", 0.01, 0.05, 0.1)
                    .containsDoubleArrayEntry("coins", Arrays.asList(0.01, 0.05, 0.1)))
        .hasEvents(EVENTS)
