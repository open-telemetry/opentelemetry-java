...
public class SpanBuilderSdkTest {
  ...
  public void addLink() {
    ...
    spanBuilder.addLink(ResolvedLink.create(DefaultSpan.getInvalid().getContext()));
  ...
  public void truncateLink() {
    ...
    try {
      ...
      List<ResolvedLink> links = spanData.getLinks();
      assertThat(links.size()).isEqualTo(maxNumberOfLinks);
      for (int i = 0; i < maxNumberOfLinks; i++) {
        assertThat(links.get(i)).isEqualTo(ResolvedLink.create(sampledSpanContext));
