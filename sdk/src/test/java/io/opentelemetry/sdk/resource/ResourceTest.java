...
public class ResourceTest {
  ...
  private static final Resource DEFAULT_RESOURCE =
      Resource.create(Collections.<String, ResourceValue>emptyMap());
  private Resource resource1;
  private Resource resource2;

  @Before
  public void setUp() {
    Map<String, ResourceValue> labelMap1 = new HashMap<>();
    labelMap1.put("a", ResourceValue.create("1"));
    labelMap1.put("b", ResourceValue.create("2"));
    Map<String, ResourceValue> labelMap2 = new HashMap<>();
    labelMap2.put("a", ResourceValue.create("1"));
    labelMap2.put("b", ResourceValue.create("3"));
    labelMap2.put("c", ResourceValue.create("4"));
  ...
  public void create() {
    ...
    Resource resource1 = Resource.create(Collections.<String, ResourceValue>emptyMap());
  ...
  public void testMergeResources() {
    Map<String, ResourceValue> expectedLabelMap = new HashMap<>();
    expectedLabelMap.put("a", ResourceValue.create("1"));
    expectedLabelMap.put("b", ResourceValue.create("2"));
    expectedLabelMap.put("c", ResourceValue.create("4"));
  ...
  public void testMergeResources_Resource1_Null() {
    Map<String, ResourceValue> expectedLabelMap = new HashMap<>();
    expectedLabelMap.put("a", ResourceValue.create("1"));
    expectedLabelMap.put("b", ResourceValue.create("3"));
    expectedLabelMap.put("c", ResourceValue.create("4"));
