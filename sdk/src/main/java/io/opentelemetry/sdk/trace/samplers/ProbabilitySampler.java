...
@AutoValue
@Immutable
public abstract class ProbabilitySampler implements Sampler {
  ...
  public final Decision shouldSample(
      ...
      SpanId spanId,
      String name,
      @Nullable List<SpanContext> parentLinks) {
    ...
    if (parentLinks != null) {
      ...
      for (SpanContext parentLink : parentLinks) {
        if (parentLink.getTraceOptions().isSampled()) {
          return new SimpleDecision(/* decision= */ true);
        }
      }
    }
