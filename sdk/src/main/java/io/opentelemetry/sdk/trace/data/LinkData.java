...
@Immutable
@AutoValue
public abstract class LinkData implements Link {
   ...
   * @since 0.1.0
   */
  public static LinkData create(SpanContext spanContext, Map<String, AttributeValue> attributes) {
    return new AutoValue_LinkData(
        spanContext,
