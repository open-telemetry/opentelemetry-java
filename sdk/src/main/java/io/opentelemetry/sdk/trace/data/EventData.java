...
@Immutable
@AutoValue
public abstract class EventData implements Event {

  /**
   * Returns a new immutable {@code EventData}.
   *
   ...
   * @return a new immutable {@code EventData<T>}
   * @since 0.1.0
   */
  public static EventData create(
      long epochNanos, String name, Map<String, AttributeValue> attributes) {
    return new AutoValue_EventData(epochNanos, name, attributes, attributes.size());
  }
  ...
  public static EventData create(
    ...
    return new AutoValue_EventData(epochNanos, name, attributes, totalAttributeCount);
  }
