...
public abstract class Aggregation {
  ...
  /**
   * Calculate sum on aggregated recorded measurements.
   *
   * @since 0.1.0
   */
  @Immutable
  ...
  /**
   * Calculate count on aggregated recorded measurements.
   *
   * @since 0.1.0
   */
  @Immutable
  ...
  /**
   * Calculate distribution stats on aggregated recorded measurements. Distribution includes mean,
  ...
  /**
   * Calculate the last value of aggregated recorded measurements.
   *
   * @since 0.1.0
   */
  @Immutable
