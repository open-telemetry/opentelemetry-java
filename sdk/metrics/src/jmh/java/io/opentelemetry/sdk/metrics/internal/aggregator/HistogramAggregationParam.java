...
public enum HistogramAggregationParam {
  EXPLICIT_DEFAULT_BUCKET(new DoubleHistogramAggregator(
      ExplicitBucketHistogramUtils.createBoundaryArray(ExplicitBucketHistogramUtils.DEFAULT_HISTOGRAM_BUCKET_BOUNDARIES),
      ExemplarReservoir::noSamples)),
  EXPLICIT_SINGLE_BUCKET(new DoubleHistogramAggregator(
