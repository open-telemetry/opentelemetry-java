...
/**
 * This interface represents information about the current collection/collector passed
 * down between the SDK meter provider and its internal storage mechanisms.
 */
@AutoValue
@Immutable
