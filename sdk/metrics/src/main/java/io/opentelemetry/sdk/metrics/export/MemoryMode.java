...
public enum MemoryMode {
   ...
   * <p>
   * In this mode, metric data collection, done by the {@link MetricReader},
   * reuses objects to significantly reduce garbage collection, at the expense of
   * disallowing concurrent collection operations.
   * <p>
   * More specifically, {@link MetricData} objects returned by the registered
   ...
   * be used once. This allows running {@link MetricReader} collection operations concurrently, at the
   * expense of increased garbage collection.
   * <p>
   * More specifically, {@link MetricData} objects returned by the registered
