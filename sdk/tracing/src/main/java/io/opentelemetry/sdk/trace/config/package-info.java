 ...
 *       {@code Span}.
 *   <li>{@code otel.span.event.count.limit}: to set the global default max number of events per {@code
 *       Span}.
 *   <li>{@code otel.span.link.count.limit}: to set the global default max number of links per {@code
 *       Span}.
 ...
 *       {@code Span}.
 *   <li>{@code OTEL_SPAN_EVENT_COUNT_LIMIT}: to set the global default max number of events per {@code
 *       Span}.
 *   <li>{@code OTEL_SPAN_LINK_COUNT_LIMIT}: to set the global default max number of links entries per
 *       {@code Span}.
