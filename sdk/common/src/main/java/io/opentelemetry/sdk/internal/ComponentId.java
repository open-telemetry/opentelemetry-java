...
public abstract class ComponentId {
  ...
  public enum StandardExporterType {
    OTLP_GRPC_SPAN_EXPORTER("otlp_grpc_span_exporter", ComponentId.Signal.SPAN),
    OTLP_HTTP_SPAN_EXPORTER("otlp_http_span_exporter", ComponentId.Signal.SPAN),
    OTLP_HTTP_JSON_SPAN_EXPORTER("otlp_http_json_span_exporter", ComponentId.Signal.SPAN),
    OTLP_GRPC_LOG_EXPORTER("otlp_grpc_log_exporter", ComponentId.Signal.LOG),
    OTLP_HTTP_LOG_EXPORTER("otlp_http_log_exporter", ComponentId.Signal.LOG),
    OTLP_HTTP_JSON_LOG_EXPORTER("otlp_http_json_log_exporter", ComponentId.Signal.LOG),
    OTLP_GRPC_METRIC_EXPORTER("otlp_grpc_metric_exporter", ComponentId.Signal.METRIC),
    OTLP_HTTP_METRIC_EXPORTER("otlp_http_metric_exporter", ComponentId.Signal.METRIC),
    OTLP_HTTP_JSON_METRIC_EXPORTER("otlp_http_json_metric_exporter", ComponentId.Signal.METRIC),
    ZIPKIN_HTTP_SPAN_EXPORTER("zipkin_http_span_exporter", ComponentId.Signal.SPAN),
    /**
     ...
     */
    ZIPKIN_HTTP_JSON_SPAN_EXPORTER("zipkin_http_span_exporter", ComponentId.Signal.SPAN);

    private final String value;
    private final ComponentId.Signal signal;

    StandardExporterType(String value, ComponentId.Signal signal) {
      this.value = value;
      this.signal = signal;
    }
    ...
    public ComponentId.Signal signal() {
      return signal;
    }
  }
