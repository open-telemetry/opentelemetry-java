...
/** JDK string-ops based W3C baggage propagator. For comparison purposes. */
class JdkStringOperationsBasedPropagator implements TextMapPropagator {

  private static final String FIELD = "baggage";
  private static final List<String> FIELDS = singletonList(FIELD);
  private static final JdkStringOperationsBasedPropagator INSTANCE =
      new JdkStringOperationsBasedPropagator();

  static JdkStringOperationsBasedPropagator getInstance() {
    return INSTANCE;
  }
