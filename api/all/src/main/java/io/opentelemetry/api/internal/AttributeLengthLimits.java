...
/**
 * Truncation helpers for attribute values. Strings and byte-array values that exceed a configured
 * length limit are truncated; array and key-value-list values are recursively processed.
 *
 * <p>This class is internal and is hence not for public use. Its APIs are unstable and can change
 * at any time.
 */
public final class AttributeLengthLimits {

  private AttributeLengthLimits() {}
  ...
  /**
   * Returns true if {@code value} contains no strings, byte arrays, or nested values exceeding
   * {@code lengthLimit}.
   */
