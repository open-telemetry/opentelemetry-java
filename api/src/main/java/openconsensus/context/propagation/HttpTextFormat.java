 ...
 * Encoding is expected to conform to the HTTP Header Field semantics. Values are often encoded
 * as RPC/HTTP request headers.
 *
 * <p>The carrier of propagated data on both the client (injector) and server
