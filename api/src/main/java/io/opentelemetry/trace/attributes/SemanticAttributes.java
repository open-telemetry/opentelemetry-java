...
public final class SemanticAttributes {
  ...
  public static final StringKey NET_TRANSPORT = stringKey("net.transport");
  /** Remote address of the peer (dotted decimal for IPv4 or RFC5952 for IPv6). */
  public static final StringKey NET_PEER_IP = stringKey("net.peer.ip");
  /** Remote port number as an integer. E.g., 80. */
  public static final LongKey NET_PEER_PORT = longKey("net.peer.port");
  /** Remote hostname or similar. */
  public static final StringKey NET_PEER_NAME = stringKey("net.peer.name");
  /** Like net.peer.ip but for the host IP. Useful in case of a multi-IP host. */
  public static final StringKey NET_HOST_IP = stringKey("net.host.ip");
  /** Like net.peer.port but for the host port. */
  public static final LongKey NET_HOST_PORT = longKey("net.host.port");
  /** Local hostname or similar. */
  public static final StringKey NET_HOST_NAME = stringKey("net.host.name");

  /** Logical name of a remote service. */
  public static final StringKey PEER_SERVICE = stringKey("peer.service");
   ...
   */
  public static final StringKey ENDUSER_ID = stringKey("enduser.id");
  /**
   * Actual/assumed role the client is making the request under extracted from token or application
   * security context.
   */
  public static final StringKey ENDUSER_ROLE = stringKey("enduser.role");
  /**
   ...
   */
  public static final StringKey ENDUSER_SCOPE = stringKey("enduser.scope");
  /** HTTP request method. E.g. "GET". */
  public static final StringKey HTTP_METHOD = stringKey("http.method");
  /** Full HTTP request URL in the form scheme://host[:port]/path?query[#fragment]. */
  public static final StringKey HTTP_URL = stringKey("http.url");
  /** The full request target as passed in a HTTP request line or equivalent. */
  public static final StringKey HTTP_TARGET = stringKey("http.target");
  /** The value of the HTTP host header. */
  public static final StringKey HTTP_HOST = stringKey("http.host");
  /** The URI scheme identifying the used protocol: "http" or "https". */
  public static final StringKey HTTP_SCHEME = stringKey("http.scheme");
  /** HTTP response status code. E.g. 200 (integer) If and only if one was received/sent. */
  public static final LongKey HTTP_STATUS_CODE = longKey("http.status_code");
  /** HTTP reason phrase. E.g. "OK" */
  public static final StringKey HTTP_STATUS_TEXT = stringKey("http.status_text");
  /** Kind of HTTP protocol used: "1.0", "1.1", "2", "SPDY" or "QUIC". */
  public static final StringKey HTTP_FLAVOR = stringKey("http.flavor");
  /** Value of the HTTP "User-Agent" header sent by the client. */
  public static final StringKey HTTP_USER_AGENT = stringKey("http.user_agent");
  /** The primary server name of the matched virtual host. Usually obtained via configuration. */
  public static final StringKey HTTP_SERVER_NAME = stringKey("http.server_name");
  /** The matched route (path template). */
  public static final StringKey HTTP_ROUTE = stringKey("http.route");
  /** The IP address of the original client behind all proxies, if known. */
  public static final StringKey HTTP_CLIENT_IP = stringKey("http.client_ip");
  /**
   * The size of the request payload body, in bytes. For payloads using transport encoding, this is
   * the compressed size.
   */
  public static final LongKey HTTP_REQUEST_CONTENT_LENGTH = longKey("http.request_content_length");
  /**
   * The size of the uncompressed request payload body, in bytes. Only set for requests that use
   * transport encoding.
   */
  public static final LongKey HTTP_REQUEST_CONTENT_LENGTH_UNCOMPRESSED =
   ...
   * the compressed size.
   */
  public static final LongKey HTTP_RESPONSE_CONTENT_LENGTH =
   ...
   * transport encoding.
   */
  public static final LongKey HTTP_RESPONSE_CONTENT_LENGTH_UNCOMPRESSED =
      longKey("http.response_content_length_uncompressed");

  /** A string identifying the remoting system, e.g., "grpc", "java_rmi" or "wcf". */
  public static final StringKey RPC_SYSTEM = stringKey("rpc.system");
  /** The full name of the service being called, including its package name, if applicable. */
  public static final StringKey RPC_SERVICE = stringKey("rpc.service");
  /* The name of the method being called, must be equal to the $method part in the span name */
  public static final StringKey RPC_METHOD = stringKey("rpc.method");
  ...
  public static final StringKey GRPC_MESSAGE_TYPE = stringKey("message.type");
  /** gRPC span event attribute starting from 1 for each of sent messages and received messages. */
  public static final LongKey GRPC_MESSAGE_ID = longKey("message.id");
  /** gRPC span event attribute for compressed size of a message. */
  public static final LongKey GRPC_MESSAGE_COMPRESSED_SIZE = longKey("message.compressed_size");
  /** gRPC span event attribute for uncompressed size of a message. */
  public static final LongKey GRPC_MESSAGE_UNCOMPRESSED_SIZE = longKey("message.uncompressed_size");
   ...
   */
  public static final StringKey DB_SYSTEM = stringKey("db.system");
  /** Database name. */
  public static final StringKey DB_NAME = stringKey("db.name");
  /**
   ...
   */
  public static final StringKey DB_CONNECTION_STRING = stringKey("db.connection_string");
  /** Database statement for the given database type. */
  public static final StringKey DB_STATEMENT = stringKey("db.statement");
  /** Database operation that is being executed. */
  public static final StringKey DB_OPERATION = stringKey("db.operation");
  /** Username for accessing database. */
  public static final StringKey DB_USER = stringKey("db.user");
   ...
   */
  public static final StringKey MSSQL_SQL_SERVER = stringKey("db.mssql.instance_name");
  /**
   ...
   */
  public static final StringKey JDBC_DRIVER_CLASSNAME = stringKey("db.jdbc.driver_classname");

  /**
   * For db.system == cassandra, the name of the keyspace being accessed. To be used instead of the
   * generic db.name attribute.
   */
  public static final StringKey CASSANDRA_KEYSPACE = stringKey("db.cassandra.keyspace");
  /**
   * For db.system == hbase, the namespace being accessed. To be used instead of the generic db.name
   * attribute.
   */
  public static final StringKey HBASE_NAMESPACE = stringKey("db.hbase.namespace");
  /**
   ...
   */
  public static final StringKey REDIS_DATABASE_INDEX = stringKey("db.redis.database_index");
  /**
   * For db.system == mongodb, the collection being accessed within the database stated in db.name
   */
  public static final StringKey MONGODB_COLLECTION = stringKey("db.mongodb.collection");

  /** A string identifying the messaging system such as kafka, rabbitmq or activemq. */
  public static final StringKey MESSAGING_SYSTEM = stringKey("messaging.system");
  /**
   * The message destination name, e.g. MyQueue or MyTopic. This might be equal to the span name but
   * is required nevertheless
   */
  public static final StringKey MESSAGING_DESTINATION = stringKey("messaging.destination");
  /** The kind of message destination. Either queue or topic. */
  public static final StringKey MESSAGING_DESTINATION_KIND =
      stringKey("messaging.destination_kind");
  /** A boolean that is true if the message destination is temporary. */
  public static final BooleanKey MESSAGING_TEMP_DESTINATION =
  ...
  public static final StringKey MESSAGING_PROTOCOL_VERSION =
      stringKey("messaging.protocol_version");
  /**
   * Connection string such as tibjmsnaming://localhost:7222 or
   * https://queue.amazonaws.com/80398EXAMPLE/MyQueue
   */
  public static final StringKey MESSAGING_URL = stringKey("messaging.url");
  /**
   * A value used by the messaging system as an identifier for the message, represented as a string.
   */
  public static final StringKey MESSAGING_MESSAGE_ID = stringKey("messaging.message_id");
  /**
   ...
   */
  public static final LongKey MESSAGING_MESSAGE_PAYLOAD_SIZE_BYTES =
      longKey("messaging.message_payload_size_bytes");
  /** The compressed size of the message payload in bytes. */
  public static final LongKey MESSAGING_MESSAGE_PAYLOAD_COMPRESSED_SIZE_BYTES =
   ...
   */
  public static final StringKey MESSAGING_OPERATION = stringKey("messaging.operation");
  ...
  public static final StringKey EXCEPTION_TYPE = stringKey("exception.type");
  /** The exception message. */
  public static final StringKey EXCEPTION_MESSAGE = stringKey("exception.message");
  /**
   * A string representing the stacktrace of an exception, as produced by {@link
   * Throwable#printStackTrace()}.
   */
  public static final StringKey EXCEPTION_STACKTRACE = stringKey("exception.stacktrace");

  /** Id of the thread that has started a span, as produced by {@link Thread#getId()}. */
  public static final LongKey THREAD_ID = longKey("thread.id");
