...
public interface CorrelationContext {
  ...
  interface Builder {
     ...
     * {@link CurrentContext#getCorrelationContext()} at {@link #build()} time will be used as
     ...
     * CurrentContext#getCorrelationContext()} at {@link #build()} time will be used as parent.
     *
     * @return this.
     * @since 0.1.0
     */
