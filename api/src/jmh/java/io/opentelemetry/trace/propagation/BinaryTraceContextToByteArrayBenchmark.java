...
public class BinaryTraceContextToByteArrayBenchmark {
  ...
  private List<SpanContext> spanContextList =
      Arrays.asList(
          ...
          createSpanContext("2e7d0ad2390617702e7d0ad239061770", "d49582a2de984b86"),
          createSpanContext("905734c59b913b4a905734c59b913b4a", "776ff807b787538a"),
          createSpanContext("68ec932c33b3f2ee68ec932c33b3f2ee", "68ec932c33b3f2ee"));
  private SpanContext spanContext = spanContextList.get(0);
  ...
  public byte[] measureToByteArray() {
    return binaryTraceContext.toByteArray(spanContext);
  }
  ...
  private SpanContext createSpanContext(String traceIdBase16, String spanIdBase16) {
    return SpanContext.create(
        TraceId.fromLowerBase16(traceIdBase16, 0),
        SpanId.fromLowerBase16(spanIdBase16, 0),
        this.sampledTraceOptions,
        this.traceStateDefault);
  }
}
