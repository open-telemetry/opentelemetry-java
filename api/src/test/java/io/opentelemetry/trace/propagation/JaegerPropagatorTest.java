...
public class JaegerPropagatorTest {
  ...
  public void inject_SampledContext() {
    ...
    assertThat(carrier)
        .containsEntry(
            TRACE_ID_HEADER,
            generateTraceIdHeaderValue(TRACE_ID_BASE16, SPAN_ID_BASE16, PARENT_SPAN, "1"));
  }
  ...
  public void inject_NotSampledContext() {
    ...
    assertThat(carrier)
        .containsEntry(
            TRACE_ID_HEADER,
            generateTraceIdHeaderValue(TRACE_ID_BASE16, SPAN_ID_BASE16, PARENT_SPAN, "0"));
  }

  @Test
  public void extract_EmptyHeaderValue() {
    Map<String, String> invalidHeaders = new LinkedHashMap<>();
    invalidHeaders.put(TRACE_ID_HEADER, "");
  ...
  public void extract_NotEnoughParts() {
    Map<String, String> invalidHeaders = new LinkedHashMap<>();
    invalidHeaders.put(TRACE_ID_HEADER, "aa:bb:cc");
  ...
  public void extract_TooManyParts() {
    Map<String, String> invalidHeaders = new LinkedHashMap<>();
    invalidHeaders.put(TRACE_ID_HEADER, "aa:bb:cc:dd:ee");
  ...
  public void extract_InvalidTraceId() {
    ...
    invalidHeaders.put(
        ...
        generateTraceIdHeaderValue(
            "abcdefghijklmnopabcdefghijklmnop", SPAN_ID_BASE16, PARENT_SPAN, "0"));
  ...
  public void extract_InvalidTraceId_Size() {
    ...
    invalidHeaders.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(TRACE_ID_BASE16 + "00", SPAN_ID_BASE16, PARENT_SPAN, "0"));
  ...
  public void extract_InvalidSpanId() {
    ...
    invalidHeaders.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(TRACE_ID_BASE16, "abcdefghijklmnop", PARENT_SPAN, "0"));
  ...
  public void extract_InvalidSpanId_Size() {
    ...
    invalidHeaders.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(TRACE_ID_BASE16, SPAN_ID_BASE16 + "00", PARENT_SPAN, "0"));
  ...
  public void extract_InvalidFlags() {
    ...
    invalidHeaders.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(TRACE_ID_BASE16, SPAN_ID_BASE16, PARENT_SPAN, ""));
  ...
  public void extract_InvalidFlags_Size() {
    ...
    invalidHeaders.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(TRACE_ID_BASE16, SPAN_ID_BASE16, PARENT_SPAN, "10220"));
  ...
  public void extract_InvalidFlags_NonNumeric() {
    ...
    invalidHeaders.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(TRACE_ID_BASE16, SPAN_ID_BASE16, PARENT_SPAN, "abcdefr"));
  ...
  public void extract_SampledContext_Short_TraceId() {
    ...
    carrier.put(
        TRACE_ID_HEADER,
        generateTraceIdHeaderValue(SHORT_TRACE_ID_BASE16, SPAN_ID_BASE16, PARENT_SPAN, "1"));
  ...
  private static String generateTraceIdHeaderValue(
      String traceId, String spanId, String parentSpan, String sampled) {
