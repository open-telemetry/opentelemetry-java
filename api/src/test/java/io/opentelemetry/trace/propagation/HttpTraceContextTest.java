...
public class HttpTraceContextTest {
  ...
  public void inject_Nothing() {
    ...
    httpTraceContext.inject(CurrentContext.get(), carrier, setter);
  ...
  public void extract_SampledContext() {
    ...
    assertThat(getSpanContext(httpTraceContext.extract(CurrentContext.get(), carrier, getter)))
        .isEqualTo(
  ...
  public void extract_EmptyHeader() {
    ...
    assertThat(
            getSpanContext(httpTraceContext.extract(CurrentContext.get(), invalidHeaders, getter)))
  ...
  public void extract_emptyCarrier() {
    ...
    assertThat(getSpanContext(httpTraceContext.extract(CurrentContext.get(), emptyHeaders, getter)))
        .isSameInstanceAs(SpanContext.getInvalid());
  }
}
