...
class ImmutableBaggageTest {
  ...
  void toBuilder_keepsOriginalState() {
    ...
    Baggage parentedBaggage = Baggage.builder().setParent(Context.root().with(originalBaggage))
        .build();
  ...
  void toBuilder_allowChanges() {
    ...
    Baggage singleItemWithParent = Baggage.builder()
    ...
    assertThat(singleItemNoParent.toBuilder().put("key2", "value2").build()).isEqualTo(
        Baggage.builder().put("key1", "value1").put("key2", "value2").setNoParent().build());
    assertThat(singleItemNoParent.toBuilder().put("key1", "value2").build()).isEqualTo(
        Baggage.builder().put("key1", "value2").setNoParent().build());

    assertThat(singleItemWithParent.toBuilder().put("key1", "value2").build()).isEqualTo(
        Baggage.builder().put("key1", "value2").setParent(Context.root().with(Baggage.empty()))
            .build());
  }
