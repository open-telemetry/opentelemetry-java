...
abstract class TraceConfigzChangeTableRow {
  ...
  @AutoValue.Builder
  interface Builder {
    TraceConfigzChangeTableRow build();
     ...
     * @return the {@link Builder}.
     */
    Builder setRowName(String rowName);
     ...
     * @return the {@link Builder}.
     */
    Builder setInputPlaceHolder(String inputPlaceholder);
     ...
     * @return the {@link Builder}.
     */
    Builder setParamDefaultValue(String defaultValue);
