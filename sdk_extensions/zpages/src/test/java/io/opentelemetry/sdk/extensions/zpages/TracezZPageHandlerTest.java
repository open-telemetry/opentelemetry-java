...
class TracezZPageHandlerTest {
  ...
  void spanDetails_emitRunningSpanDetailsCorrectly() {
    ...
    assertThat(output.toString()).contains(runningSpan.getTraceIdAsHexString());
    assertThat(output.toString()).contains(runningSpan.getSpanIdAsHexString());
  ...
  void spanDetails_emitLatencySpanDetailsCorrectly() {
    ...
    assertThat(output.toString()).contains(latencySpan1.getTraceIdAsHexString());
    assertThat(output.toString()).contains(latencySpan1.getSpanIdAsHexString());
    assertThat(output.toString()).contains(latencySpan2.getTraceIdAsHexString());
  ...
  void spanDetails_emitErrorSpanDetailsCorrectly() {
    ...
    assertThat(output.toString()).contains(errorSpan1.getTraceIdAsHexString());
    assertThat(output.toString()).contains(errorSpan1.getSpanIdAsHexString());
    assertThat(output.toString()).contains(errorSpan2.getTraceIdAsHexString());
    assertThat(output.toString()).contains(errorSpan2.getSpanIdAsHexString());
  }
