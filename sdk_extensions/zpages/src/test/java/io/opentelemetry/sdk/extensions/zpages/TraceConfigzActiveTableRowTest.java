...
/** Unit tests for {@link TraceConfigzActiveTableRow}. */
@RunWith(JUnit4.class)
public final class TraceConfigzActiveTableRowTest {
  @Test
  public void emitsHtmlCorrectly() {
    OutputStream output = new ByteArrayOutputStream();
    String paramName = "TestRow";
    String paramValue = "1.0";
    ...
    assertThat(output.toString()).contains(">" + paramName + "<");
    assertThat(output.toString()).contains(">" + paramValue + "<");
