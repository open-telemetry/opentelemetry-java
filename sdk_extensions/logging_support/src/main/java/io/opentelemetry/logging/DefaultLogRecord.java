...
public class DefaultLogRecord implements LogRecord {
  ...
  public static class Builder implements LogRecord.Builder {
    ...
    @Override
    public LogRecord.Builder withUnixTimeMillis(long timestamp) {
      return withUnixTimeNano(timestamp * 1_000_000);
    }
    ...
    @Override
    public LogRecord.Builder withBody(String body) {
      return withBody(AnyValue.stringAnyValue(body));
    }
