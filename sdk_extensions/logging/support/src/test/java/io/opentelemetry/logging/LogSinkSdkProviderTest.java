...
public class LogSinkSdkProviderTest {
  ...
  public void testBatchSize() {
    TestExporter exporter = new TestExporter();
    LogProcessor processor = BatchLogProcessor
        .builder(exporter)
  ...
  public void testNoBlocking() {
    ...
    await()
        .atMost(510, TimeUnit.MILLISECONDS)
        .until(() -> exporter.callCount == 2);
    assertThat(exporter.records.size()).isEqualTo(10); // Two exporter batches
  }
}